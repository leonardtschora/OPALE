...
%load_ext autoreload
%autoreload 1
%aimport work.analysis.metrics_utils
%aimport work.analysis.evaluate
mu = work.analysis.metrics_utils

datasets = ("validation", "test", "test_recalibrated")
versions = ("", "2", "3")
countries = ("FR", "DE", "BE", "NP", "PJM")
...
version = ""
res_val = mu.plot_scaled_metrics(results, model_wrappers, "validation", version, metrics)
...
recalibrated_test_v1_v2 = mu.plot_diff(res_test_recalibrated, res_test_recalibrated_2,
                                       ["test_recalibrated_1", "test_recalibrated_2"])
recalibrated_test_v2_v3 = mu.plot_diff(res_test_recalibrated_2, res_test_recalibrated_3,
                                       ["test_recalibrated_2", "test_recalibrated_3"])
recalibrated_test_v1_v3 = mu.plot_diff(res_test_recalibrated, res_test_recalibrated_3,
                                       ["test_recalibrated_1", "test_recalibrated_3"])
mu.plot_summary(res_test_recalibrated, res_test_recalibrated_2, res_test_recalibrated_3)
...
dms, ms = mu.compute_pvalues_cross(predictions, model_wrappers, real_prices, versions)
